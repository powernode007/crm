...
<div style="position: absolute; top: 120px; right: 100px;width:450px;height:400px;border:1px solid #D5D5D5">
    <div style="position: absolute; top: 0px; right: 60px;">
        ...
        <%--<form action="${pageContext.request.contextPath}/com.bjpn.workbench/index.html" class="form-horizontal" role="form">--%>
        <div class="form-group form-group-lg">
            ...
            <div class="checkbox" style="position: relative;top: 30px; left: 10px;">
                <label>
                    <input type="checkbox" id="loginCheck" checked="checked" > 十天内免登录
                </label>
                &nbsp;&nbsp;
                <span id="msg"></span>
            </div>
            <button type="submit" class="btn btn-primary btn-lg btn-block" id="loginSubmitBut"
